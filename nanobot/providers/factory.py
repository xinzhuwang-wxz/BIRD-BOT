...
def _make_provider_core(
    ...
    *,
    ...
    # meta-nanobot keeps two universal backends (ADR-0001): Anthropic (native SDK)
    # and the OpenAI-compatible provider, which covers OpenAI/DeepSeek/Doubao/Qwen/
    # Gemini/Moonshot/vLLM/Ollama/etc. The cloud-specific backends (bedrock,
    # azure_openai, github_copilot, openai_codex) were removed; any model that
    # used to resolve to one of them falls through to the OpenAI-compatible path.
